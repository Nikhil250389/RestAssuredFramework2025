...
import api.Methods.UserEndPoints3;
...
public class UserTest2 {
	...
	public static void setUpData() {
		...
		// logs
		logger = LogManager.getLogger(UserTest2.class.getName());
	...
	public void createUser() {
		...
		Response responce = UserEndPoints3.createUser(userPayload);
	...
	public void updateUser() {
		...
		userPayload.setJob(faker.name().firstName());
		userPayload.setName(faker.name().firstName());
		Response responce = UserEndPoints3.updateUser(userid, userPayload);
		responce.then().log().all().extract().asString();
	...
	public void getUser() {
		...
		Response responce = UserEndPoints3.getUser(userid);
		responce.then().log().all().extract().asString();
